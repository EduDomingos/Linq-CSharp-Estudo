...
namespace Linq_Estudo
{
    public class FonteDados
    {
        ...
        public static IEnumerable<Pessoa> GetPessoas()
        {
            ...
            pessoas.Add(new Pessoa(11, "Eduardo", 37));
            pessoas.Add(new Pessoa(12, "Cindy", 29));
            ...
            pessoas.Add(new Pessoa(18, "nicolas", 37));
            pessoas.Add(new Pessoa(19, "vilma", 29));
            pessoas.Add(new Pessoa(20, "Lívia", 39));
